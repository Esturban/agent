...
orders_agent = OrdersAgent(
    model=llm, tools=[get_order_details, update_quantity], system_prompt=system_prompt, debug=False
)
...
router_agent = RouterAgent(llm, system_prompt, smalltalk_prompt, debug=False)
